...
public class TestMovimiento {
     ...
     */
    @Test
    public void testMovimientoSimpleCasillaLlenoVacio()
    {
        initTablero();
        tablero.setModo(Tablero.ModoDeJuego.SIMPLE);
    ...
    public void testMovimientoGeneralValido()
    {
        ...
        tablero.setSeleccion('O');
        tablero.RealizarMovimiento(2,3);
        assertEquals("", tablero.getContenidoCeldas(2,3), Sprint3_0.Tablero.ContenidoCeldas.AZUL_O);
    }
    /*
    ...
    public void testMovimientoGeneralInValido()
    {
        ...
        tablero.RealizarMovimiento(2,3);
        assertEquals("", tablero.getContenidoCeldas(2,3), Sprint3_0.Tablero.ContenidoCeldas.AZUL_S);
